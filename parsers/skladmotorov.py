        ...
        async with self.semaphore:
            ...
            try:
                ...
                if not items:
                    ...
                    # Закрываем страницу поиска перед тем как начать грузить детали, 
                    # чтобы освободить место в семафоре если нужно
                    await page.close()
                    page = None
